...
<form action="/account" class="form-horizontal" method="post">
    {{csrf_field()}}
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <input autofocus type="text" value="{{old("fullname")}}" class="form-control" id="fullname" name="fullname" placeholder="Account Full Name">
            </div>
          </div>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
                <select class="form-control" name="country_id" id="country_id">
                    ...
                    <option {{old("country_id")==$c->id?"selected":""}} value="{{$c->id}}">{{$c->name}}</option>
                    @endforeach
                </select>
            </div>
          </div>
